(function () {
    metadata = {
      ...
      "description": "A K2 JSSP Broker KKB",
      "configuration": {
        "ServiceURL": {
    ...
    function onexecutebodyretrieveFileUrl(parameters, properties, configuration) {
      return new Promise((resolve, reject) => {
        ...
        let httpPath = `/ProspectActivity.svc/Retrieve?accessKey=${parameters["accessKey"]}&secretKey=${parameters["secretKey"]}&leadId=${parameters["leadId"]}&getFileUrl=${parameters["getFileUrl"]}`;
